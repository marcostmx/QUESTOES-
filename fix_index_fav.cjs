...
// Replace the duplicated/messy header logic
const startTarget = '<div id="quiz-container" class="max-w-4xl mx-auto flex flex-col h-full w-full p-4 md:p-12 fade-in relative hidden">';
const endTarget = '</div> <div class="flex-1 overflow-y-auto pr-2 pb-4">';

const blockStart = html.indexOf(startTarget);
const blockEnd = html.indexOf(endTarget, blockStart);
...
`;
    html = html.substring(0, blockStart) + cleanHeader + html.substring(blockEnd);
